...
trait CloudFormationDeploymentTypeParameters { this: DeploymentType =>
  ...
  val cloudFormationStackName =
    Param[String]("cloudFormationStackName",
                  documentation =
                    "The name of the CloudFormation stack to update")
  ...
  val amiParameter =
    Param[CfnParam]("amiParameter",
                    documentation =
                      "The CloudFormation parameter name for the AMI")
      .default("AMI")
