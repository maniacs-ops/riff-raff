...
object UnnaturalOrdering {
  def apply[A](order: List[A], aliensAtEnd: Boolean = true)(
      implicit oldOrdering: Ordering[A]): UnnaturalOrdering[A] = {
