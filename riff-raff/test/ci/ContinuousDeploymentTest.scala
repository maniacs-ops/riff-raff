...
class ContinuousDeploymentTest extends FlatSpec with Matchers {
  ...
  val td2QaEnabled = ContinuousDeploymentConfig(UUID.randomUUID(),
                                                ...
                                                Trigger.SuccessfulBuild,
                                                "Test user")
  val td2QaBranchEnabled = ContinuousDeploymentConfig(UUID.randomUUID(),
                                                      "tools::deploy2",
                                                      "QA",
                                                      "default",
                                                      Some("branch"),
  ...
  val contDeployBranchConfigs = Seq(tdProdEnabled,
                                    tdCodeDisabled,
                                    td2ProdDisabled,
                                    td2QaBranchEnabled,
                                    td2ProdBranchEnabled)

  val tdB71 = S3Build(45397,
                      "tools::deploy",
                      "45397",
                      "branch",
                      "71",
